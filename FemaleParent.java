...
public class FemaleParent extends Person {
  public static HashMap<String, FemaleParent> femaleparents = new HashMap<String, FemaleParent>();
  
  public FemaleParent (String n, Trait s, Trait r, Trait h, Trait e, Trait t, Trait i) {
    super(n,s,r,h,e,t,i);
    femaleparents.put(name, this);
  }
  ...
  public static void inputTraits() {
    ...
    sex = new MendelianTrait("sex", "female");
